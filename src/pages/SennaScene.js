...
const sceneQuotes = [
  ...
  "[FROG] **Cryptid Sighting Log**\n- Someone stage-dived with a foldable camping chair. They succeeded.\n- There was a mosh pit and someone in the middle was just crocheting. Steady hands. Fierce energy.",
  "**Chance You Leave With A New Friend And No Memory Of How: 100%**",
  "**Band Member Sightings at 96 Nation:**\n- Guitarist with mismatched socks playing with eyes closed the entire set\n- Bassist wearing a cardigan despite it being 90 degrees inside\n- Drummer who kept a notebook to document crowd reactions between songs\n- Synth player who brought their own lamp from home for 'the right ambiance'\n- Vocalist who performed half the set lying on the floor 'for emotional accuracy'\n- Keyboardist drinking tea from a thermos labeled 'voice juice'\n- Backup vocalist who kept forgetting they were in the band and tried to start a pit\n- Rhythm guitarist with a collection of pedals arranged in a pentagram shape\n- Violinist who showed up in formal attire to a punk show\n- Trumpet player who only played during breakdowns and crowd chants\n- Tambourine specialist wearing three different hats stacked on top of each other\n- Cellist who refused to sit and headbanged through the entire set"
];
